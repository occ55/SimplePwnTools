...
const Example = async function() {
  ...
  const Num1 = 42;
  console.log(Conv.ToBuffer(Hex1), Hex1);
  console.log(Conv.ToBuffer(`${Hex1}`), `${Hex1}`);
  console.log(Conv.ToBuffer(`${Hex1} ${Hex2}`), `${Hex1} ${Hex2}`);
  console.log(Conv.ToBuffer(`0xdeadbeef 0xdeadc0de`), `0xdeadc0de 0xdeadc0de`);
  console.log(Conv.ToBuffer(Hex1, "BE"));
  console.log(Conv.ToBuffer(Num1));
  console.log(Conv.ToBuffer(`0xdeadbeef 42 ABCD 0xdeadc0de`));
  console.log(Conv.ToBuffer("72 101 108 108 111 32 87 111 114 108 100 33").toString());
